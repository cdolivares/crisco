...
(function() {
  ...
  DefaultPut = require("" + __dirname + "/default/resource/put");

  DefaultPost = require("" + __dirname + "/default/resource/post");

  DefaultDel = require("" + __dirname + "/default/resource/del");
  ...
  ResourceDomain = (function() {
    ...
    */
    ...
    ResourceDomain.prototype.enrich = function() {
      var afterHooks, args, beforeHooks, fn, r, routeHandler, routeKeyedAfter, routeKeyedBefore, _i, _len, _ref, _ref1, _results;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        args = [routeHandler.route].concat(beforeHooks).concat([routeHandler.handler]).concat(afterHooks);
        _results.push(fn.apply(fn, args));
      }
      return _results;
    };
