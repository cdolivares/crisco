...
(function() {
  ...
  */
  ...
  MiddlewareWrapper = require("" + __dirname + "/../middleware/default/crisco_wrapper");
    ...
    */
    ...
    ResourceDomain.prototype.enrich = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        args = [routeHandler.route].concat(this.__cond.get(this.__c.domain)).concat(wrappedBeforeHooks).concat([routeHandler.handler]).concat(wrappedAfterHooks).concat([clbk]);
