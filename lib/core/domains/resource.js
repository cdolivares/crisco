    ...
    */
    ...
    ResourceDomain.prototype.enrich = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        args = [routeHandler.route].concat(this.__rInit.get(this.__config.domain)).concat(wrappedBeforeHooks).concat([routeHandler.handler]).concat(wrappedAfterHooks).concat([clbk]);
