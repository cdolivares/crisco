    ...
    */
    ...
    ActionDomain.prototype.enrich = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        args = [defaultAction.route].concat(this.__aInit.get(this.__config.domain)).concat(wrappedBeforeHooks).concat([defaultAction.handler]).concat(wrappedAfterHooks).concat([clbk]);
