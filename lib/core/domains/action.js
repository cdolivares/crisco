...
(function() {
  var ActionDomain, MWareTransformer, MiddlewareWrapper;
  ...
  */
  ...
  ActionDomain = (function() {
    ...
    */
    function ActionDomain(express, config, actionInitializer) {
      this.__e = express;
      this.__c = config;
    ...
    ActionDomain.prototype.enrich = function() {
      var afterHooks, args, beforeHooks, clbk, fn, r, routeKeyedAfter, routeKeyedBefore, wrappedAfterHooks, wrappedBeforeHooks, _i, _len, _ref, _results,
        _this = this;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        args = [r.route].concat(this.__aInit.get(this.__c.domain)).concat(wrappedBeforeHooks).concat([r.handler]).concat(wrappedAfterHooks).concat([clbk]);
