...
(function() {
  ...
  BaseResource = (function() {
    ...
    BaseResource.registerMiddleware = function(name, middleware) {
      this._m = this._m || {};
      return this._m[name] = middleware;
    };

    BaseResource.registerDecorator = function(name, dec) {
      this._d = this._d || {};
      return this._d[name] = dec;
    };
