    ...
    GET.prototype._default = function(CriscoModel, Aux, next) {
      ...
      return drivers["" + rootNode.name].findById(p, function(err, result) {
        ...
        if (err != null) {
          ...
          nArr.unshift(o);
          find = function(memo, dataObj, callback) {
            var clbk;
            ...
            return clientClbk.call(clientClbk, CriscoModel, Aux, dataObj.ownerDocs, dataObj.target, clbk);
          };
          return async.reduce(nArr, {}, find, function(err, result) {
