...
(function() {
  var CriscoResourceInit, Middleware;
    ...
    */
    ...
    '2': function(domain) {
      ...
      return function(req, res, next) {
        ...
        cm = _this.__primitiveFactory.getPrimitive("CriscoModel", domain, req, res);
  ...
  CriscoResourceInit = (function() {
    function CriscoResourceInit(database, primitiveFactory) {
      var appConfig;
