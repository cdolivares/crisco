...
(function() {
  var ApplicationInitializer, AttachmentMiddleware, AuthenticationMiddleware, BaseAction, BaseResource, BaseSchema, Crisco, Getter, Permission, PermissionMiddleware, _;
  ...
  Crisco = (function() {
    ...
    */
    ...
    Crisco.prototype.registerMiddleware = function(name, middleware) {
      ...
      return BaseResource.registerMiddleware(name, middleware);
    };
    ...
    */
    ...
    Crisco.prototype.registerDecorator = function(name, decorator) {
      this.__customDecorators[name] = decorator;
      return BaseResource.registerDecorator(name, decorator);
    };
