...
(function() {
  ...
  Middleware = {
    ...
    */
    ...
    '2': function(domain, routeInfo) {
      ...
      return function(req, res, next) {
        var aux, ca, extendedRouteInfo;

        extendedRouteInfo = _.extend(routeInfo, {
          req: req,
          res: res
        });
        ca = _this.__primitiveFactory.getPrimitive("CriscoAction", domain, extendedRouteInfo);
  ...
  */
  ...
  CriscoActionInit = (function() {
    ...
    CriscoActionInit.prototype.getExpressMiddleware = function(domain, routeInfo) {
