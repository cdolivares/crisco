  ...
  CriscoModel = (function() {
    ...
    CriscoModel.init = function(crisco, domain, routeInfo) {
      ...
      */
      ...
      StandardizedRequestObject = {
        ...
        query: req.query,
        body: req.body,
        routeConfig: this.__vars.configs.domain.resource[domain]
      };
      cm = new this(crisco, domain, this.__vars.database, StandardizedRequestObject);
      return cm;
    };
    ...
    */
    ...
    CriscoModel.prototype.targets = function() {
      ...
      z = _.reject(_.reject(this.__routeInfo.route.path.split('/'), function(r) {
        var rejectIf;

        rejectIf = /\:|^v.+\./;
        return r.match(rejectIf) != null;
      }), function(r2) {
    ...
    */
    ...
    CriscoModel.prototype.getParam = function(name) {
      ...
      regexp = "\/" + name + "\/([^\/\?]+)";
      m = this.__routeInfo.route.url.match(regexp);
      if (m == null) {
        return null;
      } else {
        return m[1];
